...
Fully-authored prompt recipes — starting points, not the default amount of augmentation for every request. Keep user-provided requirements and add detail only per the specificity policy in `prompting.md`.
