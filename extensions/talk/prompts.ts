// Tool definitions and prompt templates, ported from Codex's realtime stack
// (methods_v2.rs and prompts/templates/realtime/*).
...
export const BACKEND_PROMPT = `## Identity, tone, and role
...
export const REALTIME_START = `Realtime conversation started.
...
export const REALTIME_END = `Realtime conversation ended.
