 ...
 *
 * This extension wraps the bash tool to prepend the shims directory to PATH,
 ...
 *   `python -m py_compile`
 *
 * The shim scripts are located in the shims directory and
...
export default function (pi: ExtensionAPI) {
  ...
  const bashTool = createBashTool(cwd, {
    commandPrefix: `export PATH="${shimsPath}:$PATH"`,
    spawnHook: (ctx) => {
